                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="personal-Photo"
                                                                                ...
                                                                                Photo*</label>
                                                                            @if($user[0]->photo_url != "")
                                                                                <img  src="{{ asset('images/'.$user[0]->photo_url)}}"
                                                                ...
                                                                <div class="panel panel-default">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            @if($user[0]->sellers[0]->pan_card_upload != "")
                                                                                <img  src="{{ asset('images/'.$user[0]->sellers[0]->pan_card_upload)}}"
                                                                                class="img-fluid" width="50" height="50">
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            @if($user[0]->sellers[0]->adhaar_card_upload != "")
                                                                                <img  src="{{ asset('images/'.$user[0]->sellers[0]->adhaar_card_upload)}}"
                                                                                class="img-fluid" width="50" height="50">
                                                                            @endif
                                                                            <input type="file" class="form-control"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="passport-upload"
                                                                                class="fs-12 fw-bold">Passport <span
                                                                                    class="text-danger">*</span></label>
                                                                            @if($user[0]->sellers[0]->passport_upload != "")
                                                                                <img  src="{{ asset('images/'.$user[0]->sellers[0]->passport_upload)}}"
                                                                                class="img-fluid" width="50" height="50">
                                                                            @endif
                                                                            <input type="file" class="form-control"
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="mbl-ll-bill-upload"
                                                                                ...
                                                                                Bill <span
                                                                                    class="text-danger">*</span></label>
                                                                            @if($user[0]->sellers[0]->mbl_ll_bill_upload != "")
                                                                                <img  src="{{ asset('images/'.$user[0]->sellers[0]->mbl_ll_bill_upload)}}"
                                                                                class="img-fluid" width="50" height="50">
                                                                            @endif
                                                                            <input type="file" class="form-control"
