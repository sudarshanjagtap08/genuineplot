                ...
                <div class="d-flex mb-5">
                    <div class="display-box position-relative col-md-8 col-lg-6 p-5 mx-auto bg-white shadow-sm">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="col-6">
                                @if($seller->status == "")
                                    :<img src="{{asset('frontend/images/unverify.jpg')}}" width="40px">
                                @elseif($seller->status == "1")
                                    :<img src="{{asset('frontend/images/check_mark.jpg')}}" width="40px">
                                @endif
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body position-relative p-0">
                    ...
                    <!-- ========= -->
                    <!-- multistep form -->
                    <form id="multistepsform" action="{{ route('seller.register')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <fieldset>
                            ...
                            <div class="text-start">
                                ...
                                <input type="file" id="personal_photo" class="p-0" name="personal_photo"
                                    placeholder="photo" />
                            </div>
                            <div class="text-start">
                                ...
                                <div class="tab-pane fade show active" id="nav-familyMember1" role="tabpanel" aria-labelledby="nav-familyMember1-tab" tabindex="0">
                                    ...
                                    <div class="text-start mt-3">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" id="familyMember1Name" name="familymembername[1]" aria-label="familyMember1Name" class="form-input w-auto flex-grow-1 mb-0 border-0 border-bottom" placeholder="Enter the name">
                                        </div>
                                    </div>
                                    <div class="text-start mt-3">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="tel" id="familyMember1Number" name="familymembernumber[1]" aria-label="familyMember1Number" class="form-input w-auto flex-grow-1 mb-0 border-0 border-bottom" placeholder="Mobile Number">
                                        </div>
                                    </div>
                                    <div class="text-start mt-3">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="email" id="familyMember1Email" name="familymemberemail[1]" aria-label="familyMember1Email" class="form-input w-auto flex-grow-1 mb-0 border-0 border-bottom" placeholder="Email ID">
                                        </div>
                                    </div>
                                    <div class="text-start mt-3">
